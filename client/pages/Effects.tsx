        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-slate-400">
              Explore our collection of beautiful, interactive CSS effects and components
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <CardSpotlight className="p-6 h-full">
              ...
              <p className="text-slate-300 text-sm mb-4">
                Move your cursor over the card to see the spotlight effect that follows your mouse
                position.
              </p>
            ...
            <EvervaultCard className="p-6 h-full">
              ...
              <p className="text-slate-300 text-sm mb-4">
                Hover to reveal the encrypted text effect. Creates an amazing encrypted look with
                animated scrambled characters.
              </p>
              <div className="text-3xl">🔐</div>
            </EvervaultCard>

            <GradientCard gradient="from-pink-500 to-rose-600" className="p-6 h-full">
              <h2 className="text-xl font-bold mb-3">Gradient Card</h2>
              <p className="text-sm mb-4">
                Beautiful gradient backgrounds with smooth transitions and hover effects for
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <InteractiveCard className="h-full">
              ...
              <p className="text-slate-300 text-sm">
                Hover to see the lift effect. Cards respond to mouse interactions with smooth
          ...
          <GlassCard>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <h3 className="text-white font-semibold mb-2">Background Beams</h3>
                <p className="text-slate-400 text-sm">
                  Animated beam collision effects with particles
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <h3 className="text-white font-semibold mb-2">Aurora Background</h3>
                <p className="text-slate-400 text-sm">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <h3 className="text-white font-semibold mb-2">Resizable Navbar</h3>
                <p className="text-slate-400 text-sm">
